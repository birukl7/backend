...
function ProfileAvatarRing({
    ...
    return (
        ...
        >
            ...
            <Avatar
                className="absolute overflow-hidden rounded-full border border-white shadow-sm"
                style={{
                    top: inset,
                    left: inset,
                    width: avatarSize,
            ...
            >
                ...
                <AvatarFallback className="rounded-full bg-gradient-to-br from-blue-100 to-blue-50 text-xs font-semibold text-blue-700">
                    {getInitials(name)}
                </AvatarFallback>
            </Avatar>
        </div>
...
function ProfileSidebar({
    ...
    return (
        <aside className="w-56 shrink-0 space-y-2">
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        {profileCompletion >= 100 ? (
                            ...
                            <div className="mt-1">
                                ...
                                >
                                    {profileCompletion}% · Finish profile
                                </Link>
                            </div>
                        )}
                    </div>
            ...
            <div className="grid grid-cols-2 gap-1.5 rounded-xl border border-slate-200 bg-white p-2">
                {statCards.map((s) => (
                    <Link
                        key={s.label}
                        href={s.href}
                        className={`rounded-lg py-1.5 text-center transition-opacity hover:opacity-80 ${s.bg}`}
                    >
                        <p className={`text-base font-bold leading-none ${s.color}`}>
                            {s.value}
                        </p>
            ...
            <div className="divide-y divide-slate-100 overflow-hidden rounded-xl border border-slate-200 bg-white">
                {[
                    ...
                    <Link
                        key={item.label}
                        href={item.href}
                        className="group flex items-center gap-2.5 px-3 py-2.5 transition-colors hover:bg-slate-50"
                    >
                        <span
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="text-[12px] leading-tight font-medium text-slate-800">
                                {item.label}
                            </p>
